...
class BiddingRequestScreen extends StatefulWidget {
  const BiddingRequestScreen({super.key});

  @override
  State<BiddingRequestScreen> createState() => _BiddingRequestScreenState();
}

class _BiddingRequestScreenState extends State<BiddingRequestScreen> {
  List<String> images = ['', ''];
  @override
